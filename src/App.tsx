    ...
    return (
        <div>
            ...
            <div className="slideshow">
                <div>
                    <div>
                        <iframe className={"main"} src="https://1drv.ms/p/c/1dd6cff4559d638e/IQTb7e5gp80oTLMnrr2F-vqrAQCgh3yXTAZyjTz-FZVDWBY?wdAr=1.7777777777777777" width="1200vw" height="700vw" frameBorder="0">
